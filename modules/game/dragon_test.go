...
func TestOnlineUrDragonPropertyRoundtrip(t *testing.T) {
	...
	props := dragon.Properties()

	parsedDragon := &OnlineUrDragon{}
	err := parsedDragon.SetProperties(props)
	if err != nil {
		t.Errorf("failed to set dragon properties: %v", err)
	}
